...
async function test_should_create_db_with_schema_version() {
  ...
  try {
    ...
    assert('create: schema version is 1', version === 1, `got ${version}`);
    store.close();
...
async function test_should_insert_and_read_edges() {
  ...
  try {
    ...
    const n1 = store.insertNode({ name: 'A', kind: 'class', visibility: 'public', fileId, startLine: 1, endLine: 10, parentId: null, module: 'api', qualified: null, signature: null, docComment: null });
    const n2 = store.insertNode({ name: 'B', kind: 'class', visibility: 'public', fileId, startLine: 11, endLine: 20, parentId: null, module: 'api', qualified: null, signature: null, docComment: null });
...
async function test_should_cascade_delete_file() {
  ...
  try {
    ...
    const n1 = store.insertNode({ name: 'Gone', kind: 'class', visibility: 'public', fileId, startLine: 1, endLine: 5, parentId: null, module: 'api', qualified: null, signature: null, docComment: null });
    const n2 = store.insertNode({ name: 'method', kind: 'method', visibility: 'public', fileId, startLine: 6, endLine: 8, parentId: n1, module: 'api', qualified: null, signature: null, docComment: null });
    store.insertEdge(n1, n2, 'calls', null);
...
async function test_should_search_nodes_by_name() {
  ...
  try {
    ...
    store.insertNode({ name: 'UserService', kind: 'class', visibility: 'public', fileId, startLine: 1, endLine: 100, parentId: null, module: 'api', qualified: 'com.example.UserService', signature: 'public class UserService', docComment: null });
    store.insertNode({ name: 'OrderService', kind: 'class', visibility: 'public', fileId, startLine: 101, endLine: 200, parentId: null, module: 'api', qualified: 'com.example.OrderService', signature: 'public class OrderService', docComment: null });
...
async function test_should_search_nodes_by_signature() {
  ...
  try {
    ...
    store.insertNode({ name: 'createUser', kind: 'method', visibility: 'public', fileId, startLine: 1, endLine: 10, parentId: null, module: 'api', qualified: null, signature: 'public User createUser(CreateUserRequest req)', docComment: null });
...
async function test_should_rollback_on_error() {
  ...
  try {
    ...
    try {
      store.transaction(() => {
        store.insertNode({ name: 'Temp', kind: 'class', visibility: 'public', fileId, startLine: 1, endLine: 5, parentId: null, module: 'api', qualified: null, signature: null, docComment: null });
...
async function test_should_rebuild_on_version_mismatch() {
  ...
  try {
    ...
    store1.insertNode({ name: 'OldClass', kind: 'class', visibility: 'public', fileId, startLine: 1, endLine: 5, parentId: null, module: 'legacy', qualified: null, signature: null, docComment: null });
    store1.close();

    // Re-open — should detect mismatch and rebuild
    const store2 = GraphStore.open(dbPath);
    const version = store2.schemaVersion();
    assert('rebuild: version reset to 1', version === 1, `got ${version}`);
...
async function test_should_return_graph_stats() {
  ...
  try {
    ...
    const n1 = store.insertNode({ name: 'A', kind: 'class', visibility: 'public', fileId: f1, startLine: 1, endLine: 10, parentId: null, module: 'api', qualified: null, signature: null, docComment: null });
    const n2 = store.insertNode({ name: 'B', kind: 'class', visibility: 'public', fileId: f2, startLine: 1, endLine: 10, parentId: null, module: 'api', qualified: null, signature: null, docComment: null });
    store.insertEdge(n1, n2, 'calls', null);
